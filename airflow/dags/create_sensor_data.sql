CREATE TABLE IF NOT EXISTS dbtdb.sensor_data(sense_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
        date_time DATETIME, station_id INT, col3 FLOAT, col4 FLOAT, col5 FLOAT, col6 FLOAT, col7 FLOAT,
